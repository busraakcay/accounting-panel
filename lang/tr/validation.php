...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'company' => 'Firma',
        'productName' => 'Mal hizmet',
        'unitPrice' => 'Birim fiyat',
        'billDate' => 'Fatura tarihi',
        'quantity' => 'Miktar',
        'quantityType' => 'Miktar Tipi',
        'vatRate' => 'KDV oranı',
        'vatAmount' => 'KDV miktarı',
        'discountRateofInc' => 'İskonto oranı',
        'discountIncAmount' => 'İskonto miktarı',
        'reasonforDiscountInc' => 'İskonto nedeni',
        'otherTaxes' => 'Diğer vergiler',
        'billType' => 'Fatura tipi',
        'totalAmount' => 'Mal hizmet tutarı',
