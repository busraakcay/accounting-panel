...
<div class="card card-custom">
    ...
    <form action="<?php echo e(route('product-store',  $billId)); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input value="<?php echo e(old('unitPrice')); ?>" onblur="calculate()" type="text" class="form-control" placeholder="Ürünün birim fiyatı" name="unitPrice" id="unitPrice">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="form-group">
                                ...
                                <input value="<?php echo e(old('quantity')); ?>" onblur="calculate()" type="text" class="form-control" placeholder="Ürün miktarı" name="quantity" id="quantity">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input value="<?php echo e(old('totalAmount')); ?>" type="text" class="form-control" placeholder="Mal Hizmet Tutarı" name="totalAmount" id="totalAmount">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="<?php echo e(old('vatRate')); ?>" onblur="calculate()" type="text" class="form-control" placeholder="KDV Oranı" name="vatRate" id="vatRate">
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input value="<?php echo e(old('vatAmount')); ?>" type="text" class="form-control" placeholder="KDV Tutarı" name="vatAmount" id="vatAmount">
                            <div class="input-group-prepend">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="<?php echo e(old('discountRateofInc')); ?>" onblur="calculate()" type="text" class="form-control" placeholder="İskonto Oranı" name="discountRateofInc" id="discountRateofInc">
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input value="<?php echo e(old('discountIncAmount')); ?>" type="text" class="form-control" placeholder="İskonto Tutarı" name="discountIncAmount" id="discountIncAmount">
                            <div class="input-group-prepend">
                                <div class="input-group-text">TL</div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boltat\resources\views/product/create.blade.php ENDPATH**/ ?>