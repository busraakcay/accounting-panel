<div class="container">
                    ...
                    <tbody class="datatable-body">
                        ...
                        <tr class="datatable-row">
                            ...
                            <td width="10%" class="datatable-cell" data-label="İşlemler">
                                <span>
                                    <a wire:click="OpenEditCompanyModal(<?php echo e($company->id); ?>)" class="btn btn-sm btn-light btn-text-primary btn-icon mr-2" title="Güncelle">
    ...
    <?php echo $__env->make('modals.company.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('modals.company.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
<script>
