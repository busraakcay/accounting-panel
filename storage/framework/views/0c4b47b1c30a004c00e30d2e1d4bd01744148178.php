    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Fatura Türünü Güncelle</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="update">
                    ...
                    <div class="form-group">
                        ...
                        <span class="text-danger"> <?php $__errorArgs = ['billTypeName'];
...
</div><?php /**PATH C:\xampp\htdocs\boltat\resources\views/modals/bill-type-edit.blade.php ENDPATH**/ ?>