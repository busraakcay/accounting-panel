                    ...
                    <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
                        <table id="place" class="table-stack datatable-table">
                            ...
                            <tbody class="datatable-body">
                                ...
                                <tr class="datatable-row">
                                    <td width="70%" class="datatable-cell" data-label="Ad">{{$incomeType->name}}</td>
                                    <td width="30%" class="datatable-cell" data-label="İşlemler">
                                        <span>
                                            <a wire:click="OpenEditBillTypeModal({{$incomeType->id}}, {{ '1' }})" class="btn btn-sm btn-light btn-text-primary btn-icon mr-2" title="Güncelle">
                                            ...
                                            <a wire:click="deleteConfirm({{ $incomeType->id }}, {{ '1' }})" class="btn btn-sm btn-light btn-text-primary btn-icon" title="Sil">
                                                <span class="svg-icon svg-icon-md">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect x="0" y="0" width="24" height="24"></rect>
                ...
                <div class="card-body">
                    <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded">
                        <table id="place" class="table-stack datatable-table">
                            ...
                            <tbody class="datatable-body">
                                @forelse ($expenseTypes as $expenseTypes)
                                <tr class="datatable-row">
                                    ...
                                    <td width="30%" class="datatable-cell" data-label="İşlemler">
                                        <span>
                                            ...
                                            <a wire:click="deleteConfirm({{ $expenseTypes->id }}, {{ '2' }})" class="btn btn-sm btn-light btn-text-primary btn-icon" title="Sil">
                                                <span class="svg-icon svg-icon-md">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect x="0" y="0" width="24" height="24"></rect>
