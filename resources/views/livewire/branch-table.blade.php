        ...
        <table id="place" class="table-stack datatable-table">
            ...
            <tbody class="datatable-body">
                ...
                <tr class="datatable-row">
                    ...
                    <td width="30%" class="datatable-cell" data-label="Nakit Miktarı">{{$branch->amount_cash}}</td>
                    <form action="{{ route('delete-branch', $branch->id) }}" id="deleteForm-{{ $branch->id }}" method="post" class="hidden">
                        @csrf @method('delete')
                    </form>
                    <td width="20%" class="datatable-cell" data-label="İşlemler">
                        <span>
                            ...
                            <a onclick="sure(this.id);" id="{{$branch->id}}" class="btn btn-sm btn-light btn-text-primary btn-icon" title="Sil">
                                <span class="svg-icon svg-icon-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"></rect>
