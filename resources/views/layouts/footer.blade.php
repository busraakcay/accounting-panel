...
<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
	<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
		<div class="text-dark order-2 order-md-1">
			<span class="text-muted font-weight-bold mr-2">{{ "Tüm hakları saklıdır." }}</span>
		</div>
	</div>
</div>
</div>
...
<script src="{{ asset('assets/panel/js/bootstrap-toggle.min.js') }}"></script>
<script src="{{ asset('assets/panel/plugins/custom/fullcalendar/fullcalendar.bundle15aa.js') }}"></script>
<script src="{{ asset('assets/panel/plugins/custom/gmaps/gmaps15aa.js') }}"></script>
...
<script src="{{ asset('assets/panel/js/variation.js') }}"></script>
<script src="{{ asset('assets/panel/js/multiselect_row_table.js') }}"></script>
