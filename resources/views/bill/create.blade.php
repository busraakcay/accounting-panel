...
<div class="card card-custom">
    ...
    <form class="form repeater" id="kt_form" action="{{ route('store-bill') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('unitPrice') }}" type="text" onblur="calculate(false)" class="form-control" placeholder="Ürünün birim fiyatı" name="unitPrice">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('quantity') }}" onblur="calculate(false)" type="text" class="form-control" placeholder="Ürün miktarı" name="quantity">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="{{ old('vatRate') }}" onblur="calculate(false)" type="text" class="form-control" placeholder="KDV Oranı" name="vatRate">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="{{ old('discountRateofInc') }}" onblur="calculate(false)" type="text" class="form-control" placeholder="İskonto Oranı" name="discountRateofInc">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('totalAmount') }}" id="totalAmount" type="text" class="form-control" placeholder="Mal Hizmet Tutarı" name="totalAmount">
                                        </div>
                                    </div>
